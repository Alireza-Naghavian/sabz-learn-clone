import { TableStyleType } from "@/types/Table.t";
...
const tableRowStyle = cva("", {
  variants: {
    variant: {
      singleHead: `my-1 child:my-auto child:mx-auto   py-4 rounded-lg `,
      multipleHead: `lg:grid flex flex-col 
      w-full child:my-auto child:text-center child:mx-auto   
      mt-[35px] lg:mt-6 child:text-gray-700 lg:rounded-lg child:text-base child:font-DanaBold 
