...
import { PriceTextFieldType } from "@/types/textFilels.t";

const inputGroup = cva(
  " dark:bg-dark dark:text-white text-gray-900 bg-gray-100 focus:outline-none font-Dana w-full text-right",
  {
    variants: {
      variant: {
  ...
  return (
    <div className={wrapperStyles}>
      <div className="flex flex-col gap-y-2 relative">
        ...
        />
        {Icon && (
          <Icon className="     size-5 text-[#64748b] absolute left-3.5  top-[35%] " />
        )}
      </div>
      {errors && errors[name] && (
