...
async function page() {
  ...
  const mostPopularCourse =  allCourses.sort((a:CourseDataTable,b:CourseDataTable)=>{
    return Number(b.registers ) - Number(a.registers)
  }).splice(0,1)

  return (
    <OverViews salesData={dataParser(salesData)} mostPopCourses={dataParser(mostPopularCourse)} />
